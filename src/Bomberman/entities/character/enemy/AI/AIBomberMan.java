...
public class AIBomberMan extends AI
{
    ...
    int bfs(int start) throws IllegalStateException
    { // exception khi que ko còn chỗ
        // tao cai  Queue node
...
//
    ...
    public int calculateDirection()
    {
        ...
        if (result - start == 1) return 1; // sang phải
        if (start - result == 1) return 3; // sang trái
        if (start > result) return 0; // lên
        if (start < result) return 2; // dưới
